...
uses
  WinTypes, WinProcs, Classes, Graphics, Forms, Controls, Buttons, Dialogs,
  StdCtrls, ExtCtrls, RxPlacemnt, DBCtrls, DB, DBTables, Menus,
  HexDump{$IFDEF RX_D16}, UITypes{$ENDIF};
